<?php 
	...
	$searchDataSourcesReputation = $_POST['searchDataSourcesReputation'];
	
	if($searchDataSourcesReputation != ''){
	
	$q = "
	    			SELECT * FROM tdbSourcesReputation 
	    			WHERE SiteSource LIKE '%$searchDataSourcesReputation%'
	    			ORDER BY SourcesReputationID DESC";
