...
<fieldset><legend>List Of Partner Category</legend>
	
	<label id="CategoryNameLabel">Partner Category</label>
	
	<!-- Main list of Partner Category -->
	<select id="listOfSubCategory5" name="listOfSubCategory" class="listOfSubCategory" onchange="listOfPartnerCategory(this.value)">
		<option value="">--</option>
		<?php 
		$queryPartner = "SELECT * FROM `tdbAIntuitionSubCategory` WHERE AIntuitionCategoryID = 5";
	...
	<div id="displayHoldingBABUPartner" class="displayHoldingABU<?php echo $AIntuitionCategoryID;?>"></div>
